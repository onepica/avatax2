 ...
 */
class AbstractEstimation extends \PHPUnit_Framework_TestCase
{
     ...
     *  And Tax Calculation Settings/Catalog Prices set as Excluded Tax
     *  Then Tax rate should be 0.08875
     *  And Total tax should be 9.32
     *
     */
